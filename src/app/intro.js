      ...
      <section className={styles.introContainer}>
        <div className={styles.introCopyContainer}>
          <p className={styles.introCopy}>
            Artshack’s mission is so special, but our leaders are falling short of it. Specifically, Executive Director McKendree Key’s actions have failed to meet our commitment to anti-racism, diversity, equity, and inclusion. The status quo hurts beloved community members, and disrupts Artshack’s operations as a non-profit in service of its BedStuy neighbors. Community members are compiling  a timeline of recent and relevant events <a href="https://drive.proton.me/urls/3MEX7K3QQR#n8i2yEK86I32" target="__blank">here</a>.
            <br/><br/>
            Despite concerned community members’ requests to meet collectively with the Executive Director and the board to address it, no concessions have been made to engage in open, restorative dialogue between all parties. Furthermore, the Executive Director escalated their efforts to silence staff involved. We also have reason to believe the Executive Director is engaging in punitive efforts to restructure the organization to avoid accountability under the guise of financial strain, resulting in the removal of the Director of Development, Cameo, and the resignation of 4 board members, all Women of Color. Read the public letter from Cameo <a href="https://docs.proton.me/doc?type=doc&mode=open-url&token=8198D8MN70#4zNuNwKwTAP0" target="__blank">here</a>.
            <br/><br/>
            But we will not be silenced! <a href="#demands">Click here to see our demands.</a>
            <br /><br />
            In the unfortunate event that workers are let go due to their involvement, we have set up a <a href="https://opencollective.com/artshack-organizers-mutual-aid" target="__blank">mutual aid fund</a> that will continue to support them.
          </p>
